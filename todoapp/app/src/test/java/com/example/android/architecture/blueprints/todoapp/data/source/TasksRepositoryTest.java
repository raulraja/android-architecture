...
public class TasksRepositoryTest {
    ...
    public void saveTask_savesTaskToServiceAPI() {
        ...
        assertThat(mTasksRepository.getMCachedTasks().size(), is(1));
    }
    ...
    public void completeTask_completesTaskToServiceAPIUpdatesCache() {
        ...
        assertThat(mTasksRepository.getMCachedTasks().size(), is(1));
        assertThat(mTasksRepository.getMCachedTasks().get(newTask.getId()).isActive(), is(false));
    }
    ...
    public void activateTask_activatesTaskToServiceAPIUpdatesCache() {
        ...
        assertThat(mTasksRepository.getMCachedTasks().size(), is(1));
        assertThat(mTasksRepository.getMCachedTasks().get(newTask.getId()).isActive(), is(true));
    }
    ...
    public void deleteCompletedTasks_deleteCompletedTasksToServiceAPIUpdatesCache() {
        ...
        assertThat(mTasksRepository.getMCachedTasks().size(), is(1));
        assertTrue(mTasksRepository.getMCachedTasks().get(newTask2.getId()).isActive());
        assertThat(mTasksRepository.getMCachedTasks().get(newTask2.getId()).getTitle(), is(TASK_TITLE2));
    }
    ...
    public void deleteAllTasks_deleteTasksToServiceAPIUpdatesCache() {
        ...
        assertThat(mTasksRepository.getMCachedTasks().size(), is(0));
    }
    ...
    public void deleteTask_deleteTaskToServiceAPIRemovedFromCache() {
        ...
        Task newTask = new Task(TASK_TITLE, "Some Task Description", true);
        mTasksRepository.saveTask(newTask);
        assertThat(mTasksRepository.getMCachedTasks().containsKey(newTask.getId()), is(true));
        ...
        assertThat(mTasksRepository.getMCachedTasks().containsKey(newTask.getId()), is(false));
    }
